...
public class Application {
    ...
    private final MainFrame gui = new MainFrame(view);
    private final ConsoleObserver consoleObserver = new ConsoleObserver(view);

    private Application() {
        view.addObserver(gui);
        view.addObserver(consoleObserver);
    }
