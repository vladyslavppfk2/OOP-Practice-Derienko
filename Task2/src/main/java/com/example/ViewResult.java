...
/**
 * Конкретний клас відображення результатів.
 * <p>
...
public class ViewResult implements View {
     ...
     * @throws IllegalArgumentException якщо рядок не є двійковим
     */
    ...
    public void viewHeader() {
        ...
        System.out.printf("| %-2s | %-14s | %-13s | %-13s | %-8s | %-6s | %-8s |%n",
                "№", "Двійк. довжина", "Двійк. ширина", "Двійк. висота", "Периметр", "Площа", "Об'єм");
        System.out.println(LINE);
    }
    ...
    public void viewBody() {
        for (int i = 0; i < items.size(); i++) {
            ...
            System.out.printf("| %-2d | %-14s | %-13s | %-13s | %-8d | %-6d | %-8d |%n",
                    i + 1,
